             ...
             <?php foreach ($sales as $sale):?>
               <tr >
                 ...
                 <td class="text-center">
                  ...
                  <td class="text-center">
                   <?php  if($sale['upload'] != ''){ ?>
                     <a class="btn btn-success" href="uploads/products/<?=$sale['upload'];?>" target="_BLANK" title="Preview"><i class="glyphicon glyphicon-search"></i></a><a href="batal_uploadPj.php?id=<?=$sale['id']?>" class="btn btn-danger" title="Hapus">
                       <span class="glyphicon glyphicon-trash"></span></a>
                     <?php }else{ ?>
                      <a class="btn btn-primary" href="media_pertanggungjawaban.php?id=<?=$sale['id']?>" title="Upload"><i class="glyphicon glyphicon-upload"></i></a>
                    <?php } ?>
                  ...
                  <td class="text-center">
                   <?php  if($sale['file_spm'] != ''){ ?>
                     <a class="btn btn-success" href="uploads/spm/<?=$sale['file_spm'];?>" target="_BLANK" title="Preview"><i class="glyphicon glyphicon-search"></i></a><a href="batal_uploadPj.php?id=<?=$sale['id']?>" class="btn btn-danger" title="Hapus">
                       <span class="glyphicon glyphicon-trash"></span></a>
                     <?php }else{ ?>
                      <a class="btn btn-primary" href="media_pertanggungjawaban.php?id=<?=$sale['id']?>" title="Upload"><i class="glyphicon glyphicon-upload"></i></a>
                    <?php } ?>
                  ...
                  <td class="text-center">
                   <?php  if($sale['file_sp2d'] != ''){ ?>
                     <a class="btn btn-success" href="uploads/sp2d/<?=$sale['file_sp2d'];?>" target="_BLANK" title="Preview"><i class="glyphicon glyphicon-search"></i></a><a href="batal_uploadPj.php?id=<?=$sale['id']?>" class="btn btn-danger" title="Hapus">
                       <span class="glyphicon glyphicon-trash"></span></a>
                     <?php }else{ ?>
                      <a class="btn btn-primary" href="media_pertanggungjawaban.php?id=<?=$sale['id']?>" title="Upload"><i class="glyphicon glyphicon-upload"></i></a>
                    <?php } ?>
