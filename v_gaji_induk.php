      ...
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
          <strong>
            ...
            <span>Verifikasi Belanja Pegawai Induk/Susulan/kekurangan Gaji</span>
          </strong>
          ...
          <table class="table table-bordered table-striped">
           ...
           <tbody>
             ...
             <tr>
               ...
               <td>Halaman Depan</td>
                <td class="text-center">
                <?php if($verif['halaman_depan'] == 1){?>
                  <a href="proses_v.php?id=<?=$verif['id']?>&key=bhalaman_depan" class="btn btn-danger">Batal</a>
                <?php }else{ ?>
                  <a href="proses_v.php?id=<?=$verif['id']?>&key=halaman_depan" class="btn btn-success">Proses</a>
                <?php } ?>
                </td>      
             </tr>
             <tr>
             ...
             <tr>
               <td class="text-center"><?php echo count_id();?></td>
               <td>Lembar Pengujian</td>
                <td class="text-center">
                <?php if($verif['lembar_pengujian'] == 1){?>
                  <a href="proses_v.php?id=<?=$verif['id']?>&key=blembar_pengujian" class="btn btn-danger">Batal</a>
                <?php }else{ ?>
                  <a href="proses_v.php?id=<?=$verif['id']?>&key=lembar_pengujian" class="btn btn-success">Proses</a>
                <?php } ?>
                </td>      
             </tr>
             <tr>
               <td class="text-center"><?php echo count_id();?></td>
               <td>Daftar Perubahan Pegawai</td>
                <td class="text-center">
                <?php if($verif['daftar_perubahan_pegawai'] == 1){?>
                  <a href="proses_v.php?id=<?=$verif['id']?>&key=bdaftar_perubahan_pegawai" class="btn btn-danger">Batal</a>
                <?php }else{ ?>
                  <a href="proses_v.php?id=<?=$verif['id']?>&key=daftar_perubahan_pegawai" class="btn btn-success">Proses</a>
                <?php } ?>
                </td>      
             </tr>
             <tr>
