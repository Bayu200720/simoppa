       ...
       <?php } ?> 
            ...
            <?php } ?>
              ...
              <td class="text-center"><?php echo $sale['created_at']?></td>
               <td class="text-center">
                  <div class="btn-group">
                     <a href="detail_dokumen_p3.php?id=<?=$sale['id']?>" class="btn btn-success btn-xs" title="Detail status Pengajuan" data-toggle="tooltip" > <span class="glyphicon glyphicon-folder-open"></span></a>
                     <a href="detail_pengajuan_p3.php?id=<?php echo (int)$sale['id'];?>" class="btn btn-primary btn-xs"  title="Detail Pengajuan" data-toggle="tooltip">
