      ...
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
          <strong>
            ...
            <span>Verifikasi BIAYA KULIAH KAMPUS LUAR NEGERI</span>
          </strong>
          ...
          <table class="table table-bordered table-striped">
           ...
           <tbody>
             ...
             <tr>
               ...
               <td>SK Beasiswa</td>
                <td class="text-center">
                <?php if($verif['sk_bsiswa'] == 1){?>
                  <a href="proses_v.php?id=<?=$verif['id']?>&key=bsk_bsiswa" class="btn btn-danger">Batal</a>
                <?php }else{ ?>
                  <a href="proses_v.php?id=<?=$verif['id']?>&key=sk_bsiswa" class="btn btn-success">Proses</a>
                <?php } ?>
                </td>      
             </tr>
             ...
             <tr>
               <td class="text-center"><?php echo count_id();?></td>
               <td>Kwitansi atau invoice dari kampus</td>
                <td class="text-center">
                <?php if($verif['kwitansi'] == 1){?>
                  <a href="proses_v.php?id=<?=$verif['id']?>&key=bkwitansi" class="btn btn-danger">Batal</a>
                <?php }else{ ?>
                  <a href="proses_v.php?id=<?=$verif['id']?>&key=kwitansi" class="btn btn-success">Proses</a>
                <?php } ?>
                </td>      
             </tr>
           ...
           <tbody>
             ...
             <tr>
               ...
               <td>Bukti Transfer</td>
                <td class="text-center">
                 <?php if($verif['bukti_tf'] == 1){?>
                    <a href="proses_v.php?id=<?=$verif['id']?>&key=bbukti_tf" class="btn btn-danger">Batal</a>
                  <?php }else{ ?>
                    <a href="proses_v.php?id=<?=$verif['id']?>&key=bukti_tf" class="btn btn-success">Proses</a>
                  <?php } ?>
                </td>      
             </tr>
