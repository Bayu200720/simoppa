...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<tr>
	  ...
	  <td class="style28"> SK Beasiswa </td>
	  <td><center><span class="style28"><?php if($verifikasi[0]['sk_bsiswa']==1){echo "V";}?></span></center></td>
    <td><center><span class="style28"><?php if($verifikasi[0]['sk_bsiswa']==1){echo "Lengkap";}?></span></center></td>
	  </tr>
      <tr>
	  <td class="style28"><div align="center">8</div></td>
	  <td class="style28">SP Setneg Penerima Beasiswa </td>
    ...
    <td><center><span class="style28"><?php if($verifikasi[0]['sp_setneg']==1){echo "Lengkap";}?></span></center></td>
	  ...
	  <td class="style28"> Kuitansi atau invoice dari kampus </td>
...
<br />
    ...
    <td valign="top"><table width="100%" border="1" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td class="style28">Bukti Transfer </td>
        <td><center><span class="style28"><?php if($verifikasi[0]['bukti_tf']==1){echo "V";}?></span></center></td>
        <td><center><span class="style28"><?php if($verifikasi[0]['bukti_tf']==1){echo "Lengkap";}?></span></center></td>
      </tr>
      <tr>
        <td class="style28"><div align="center"></div></td>
        <td class="style28">&nbsp;</td>
