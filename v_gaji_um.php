      ...
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
          <strong>
            ...
            <span>Verifikasi Belanja Pegawai Uang Makan/Uang Lembur</span>
          </strong>
        ...
        <div class="panel-body">
          <table class="table table-bordered table-striped">
           ...
           <tbody>
             ...
             <tr>
               <td class="text-center"><?php echo count_id();?></td>
               <td>Rekapitulasi Gabung Uang Makan</td>
                <td class="text-center">
                <?php if($verif['rekapitulasi_gabung_um'] == 1){?>
                  <a href="proses_v.php?id=<?=$verif['id']?>&key=brekapitulasi_gabung_um" class="btn btn-danger">Batal</a>
                <?php }else{ ?>
                  <a href="proses_v.php?id=<?=$verif['id']?>&key=rekapitulasi_gabung_um" class="btn btn-success">Proses</a>
                <?php } ?>
                </td>      
             </tr>
             <tr>
             ...
             <tr>
               ...
               <td>Absen Lembur</td>
                ...
                <?php if($verif['absensi'] == 1){?>
                  <a href="proses_v.php?id=<?=$verif['id']?>&key=babsensi" class="btn btn-danger">Batal</a>
                <?php }else{ ?>
                  <a href="proses_v.php?id=<?=$verif['id']?>&key=absensi" class="btn btn-success">Proses</a>
                <?php } ?>
                </td>      
             </tr>
             <tr>
